...
export default async function KegiatanQrPage({ params }: Props) {
  ...
  return (
    <div className="flex flex-col items-center px-4 py-10 print:py-0">
      <div className="flex w-full max-w-md flex-col items-center rounded-xl border border-gray-200 bg-white p-8 text-center print:border-none print:p-0 print:shadow-none">
        ...
        <div className="mt-6 w-64" dangerouslySetInnerHTML={{ __html: qrSvg }} />
